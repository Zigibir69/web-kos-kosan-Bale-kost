    ...
    if ($cek->num_rows > 0) {
        ...
        switch ($aksi) {
            ...
            case 'setujui':
                ...
                $durasi = intval($pesanan['durasi_bulan']);
                ...
                $id_kamar = intval($pesanan['id_kamar']);
                $koneksi->query("UPDATE tbl_kamar SET status = 'tidak tersedia' WHERE id_kamar = $id_kamar");
...
<div class="sidebar">
    ...
    <a href="dashboard_admin.php"><i class="fa fa-chart-line me-2"></i>Dashboard</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if (!empty($row['bukti_pembayaran'])): ?>
                                                <a href="../uploads/<?= htmlspecialchars($row['bukti_pembayaran']); ?>" target="_blank" class="btn btn-sm btn-info">Lihat</a>
                                            <?php else: ?>
                                                <em>Belum bayar</em>
                                            <?php endif; ?>
                                        </td>
